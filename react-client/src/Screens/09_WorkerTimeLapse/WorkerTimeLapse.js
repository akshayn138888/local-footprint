...
const MAPBOX_TOKEN = "pk.eyJ1IjoicmRpY2siLCJhIjoiY2thbmdvYXJrMXFhZDJ3bGUzc3N4b29kYSJ9.4gZnKOxNEQ9WXEkFym7lTQ";
    ...
    const _renderLayers = () => {
        return [
            new TripsLayer({
                ...
                getPath: each => each.path.map(p => { return [p[0] - 48.855, p[1] + 8.45] }),
                // [p[0] - 48.82, p[1] + 8.425] 
