    ...
    if (latLon) {
                ...
                array1.push(
                    ...
                    >
                        <button class="marker-btn">
                            <img src="https://cdn.imgbin.com/12/4/19/imgbin-auxiliary-police-lawyer-material-people-s-police-UcqivXX1JKh98eQ2xMj1Zyan2.jpg" alt="security guard" style={{ width: 50 }} />
                        </button>
                    </Marker>
                );
            }
        ...
        return (
            <div>
                ...
                >
                    {parseData ? parseData.map(markerArray => markerArray[markerArray.length - 1]) : ""}
                </ReactMapGL>
            </div>
        );
    } else {
