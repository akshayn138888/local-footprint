      ...
      <div className="overlay">
        <h1 className="h1-full">
          ...
          >
            ...
            <Typist.Delay ms={500} />
            <h4 className="hero-h3"> Fast paced way to track your workers.</h4>
            <Typist.Delay ms={500} />
            <h5 className="hero-h5">Manage analytics like a boss.</h5>
        ...
        <div className="sect sect--padding-bottom">
          <div className="container">
            ...
            >
              ...
              >
                <div
                  className="col-md-4 col-sm-4 price-box price-box--purple"
                  style={{ margin: "1em" }}
                >
                  <div className="price-box__wrap">
                    ...
                    <ul className="price-box__list">
                      ...
                      <li className="price-box__list-el">
                        No contractors limit{" "}
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div
                  className="col-md-4 col-sm-4 price-box price-box--violet"
                  style={{ margin: "1em" }}
                >
                  <div className="price-box__wrap">
                    <div className="price-box__img"></div>
                ...
                <div
                  className="col-md-4 col-sm-4 price-box price-box--blue"
                  style={{ margin: "1em" }}
                >
                  <div className="price-box__wrap">
                    <div className="price-box__img"></div>
